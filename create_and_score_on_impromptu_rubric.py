...
def compare_ref_student_common_words(ref_text, student_response): 
    """
    INPUT: Takes reference text as a string, student_response as a string
    OUTPUT: Number of matched meaningful words and the list of meaningful words 
    Purpose: Creates an impromptu "rubric" with the new reference text. 
    TO-DO: stemming, especially for plural words like hams and ham 
    """
